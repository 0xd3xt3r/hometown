...
Contains 8 concrete steps plus a `[compose]` block that inlines 4 expansion
...
**Total steps: ~32 | Parallel groups: 4 | Human gates: 1**
...
`bd cook` resolves all `compose.expand` rules and inlines all ~32 steps.
